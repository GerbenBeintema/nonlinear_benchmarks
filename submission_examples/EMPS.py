...
train, test = nonlinear_benchmarks.EMPS()
...
test_RMSE_mm = 1000*RMSE(test.y[n:], y_test_model[n:])

print(f'{test_RMSE_mm = :.2f} mm')
print(f'RMSE to submit = {test_RMSE_mm:.2f}') # report this number during submission
